        ...
        content: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                try {
                  ...
                  if (enhancedFile != null) {
                    ...
                    messenger.showSnackBar(const SnackBar(content: Text("Enhancement failed.")));
                  }
                } catch (e) {
              ...
              child: const Text('Enhance AI', style: TextStyle(color: Colors.white)),
            ),
    ...
    return Scaffold(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(image: AssetImage('assets/icons/black_logo.png')),
              ),
            ),
            const SizedBox(width: 10),
            Text('Enhancia', style: GoogleFonts.poppins(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
          ],
        ),
        actions: [
          IconButton(
            onPressed: () => themeProvider.toggleTheme(),
            icon: Icon(themeProvider.isDarkTheme ? Icons.light_mode : Icons.dark_mode, color: Colors.white),
          ),
          IconButton(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('Enhance✨', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
            const SizedBox(height: 15),
            Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  child: const Text('Photos', style: TextStyle(color: Colors.black)),
                ),
                IconButton(
                  onPressed: _checkCameraPermission,
                  icon: const Icon(Icons.camera_alt_outlined, color: Colors.red, size: 28),
                ),
              ],
            ),
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8),
                          child: AssetEntityImage(provider.images[index], fit: BoxFit.cover),
                        ),
                      );
                    },
                  );
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          const Text('Access to photos is required', style: TextStyle(fontWeight: FontWeight.bold)),
          const SizedBox(height: 20),
          ElevatedButton(
            onPressed: _requestPhotoPermission,
            style: ElevatedButton.styleFrom(backgroundColor: themeProvider.appBarColor),
